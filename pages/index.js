...
function SocialSection({ guardiansTotal, nullTotal }) {
  ...
  return (
    <Section id="social" title="Social & Feed" icon={<Twitter className="w-6 h-6"/>} subtitle="X embed and share composer.">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="rounded-2xl"><CardHeader><CardTitle>X Feed</CardTitle></CardHeader><CardContent><div className="aspect-video w-full rounded-xl border bg-black/40 grid place-items-center text-white/70"><p>Embed your existing X feed here</p></div></CardContent></Card>
